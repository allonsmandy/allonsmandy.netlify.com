...
const AboutPage = () => (
  <Layout>
    ...
    <S.AboutDescription>
      <p>
        Olá! Meu nome é Amanda, prazer em te ter aqui! <br />
        ...
        Meu caminho pela tecnologia já se vem a um tempinho.<br /> Durante a infância, preferia ir a Lan House do que ir na Locadora onde tinha os videogames,
        tanto pelo fato de preferir descobrir cada vez mais o mundo tão expansivo da internet, como também porque tinha bem menos gente haha <br />
        ...
        Entrei no Ensino Médio integrado com Técnico de Informática com 15 anos, e partir dai comecei a desenvolver e entender bem melhor sobre as bases
        da programação, praticando a lógica e realizando diversos projetos. <br />
        Desde então, ando sempre estudando e descobrindo algo novo, expandindo minhas ideias, programando, errando e sempre aprendendo algo mais. 
...
<S.Section>
    ...
    <div>
    <S.AboutSubtitle>Skills</S.AboutSubtitle>
    <S.AboutSkillsList>
